...
public class MyApplication extends Application {
	...
	private void initFaceMap() {
		...
		mFaceMap.put("[ÍµÐ¦]", R.drawable.f003);
		...
		mFaceMap.put("[´ó¿Þ]", R.drawable.f010);
		mFaceMap.put("[Ðê]", R.drawable.f011);
