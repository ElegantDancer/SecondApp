package com.zhenzhen.secondapp.analogClock;
/*
...
public class AnalogClock extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        /**
         * 为什么 时针和分针  能够以不同的角度绘制出来
         * 原因：canvas在绘制之前  已经旋转了坐标系
         */
    ...
    private void onTimeChanged() {
        mCalendar.setToNow();
        mCalendar2.setTimeInMillis(System.currentTimeMillis());
        mCalendar2.getTime();
        ...
        int hour2 = mCalendar2.get(Calendar.HOUR);
        int minite2 = mCalendar2.get(Calendar.MINUTE);
        int second2 = mCalendar2.get(Calendar.SECOND);
